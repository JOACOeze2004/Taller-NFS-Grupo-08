...
bool Countdown::should_continue() { return gameloop->is_running() && gameloop->has_active_players();}
...
State Countdown::get_current_phase_state() const { return IN_COUNTDOWN; }